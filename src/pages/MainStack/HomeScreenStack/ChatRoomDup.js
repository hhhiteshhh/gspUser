...
const ChatRoomDup = ({navigation, route, uid}) => {
    ...
    navigation.setOptions({
      headerTitle: props => (
        <View
          ...
          <FastImage
            source={{uri: photoUrl}}
            style={{width: 40, height: 42, borderRadius: 50, marginLeft: -15}}
          />
          <Text
            {...props}
            style={{
      ...
      headerLeft: () => (
        <TouchableOpacity
          ...
          <Icon type="Entypo" name="chevron-left" size={25} />
        </TouchableOpacity>
      ),
      headerRight: () => (
        <TouchableOpacity
          ...
          // onPress={() => navigation.goBack()}
        >
          <Icon type="Feather" name="more-vert" size={25} />
        </TouchableOpacity>
      ),
      headerStyle: {
